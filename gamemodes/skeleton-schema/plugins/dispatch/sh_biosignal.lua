if SERVER then
	...
	net.Receive("impulseHL2RPBioDeath", function(len, ply)
		...
		--if unit and IsValid(unit) and unit:IsPlayer() and unit:IsCP() then
			...
			timer.Simple(2, function()
				...
				-- if unit:Team() == TEAM_OTA then
				timer.Simple(readTime + 4.3, function()
	    			surface.PlaySound("npc/overwatch/radiovoice/reportplease.wav")
				end)
				--end
			end)
		end
