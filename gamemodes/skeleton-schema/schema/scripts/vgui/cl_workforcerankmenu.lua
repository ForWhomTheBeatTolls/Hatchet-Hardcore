...
impulse.WORKFORCERankMenu = impulse.WORKFORCERankMenu or nil

function PANEL:Init()

	if impulse.WORKFORCERankMenu and IsValid(impulse.WORKFORCERankMenu) then
		impulse.WORKFORCERankMenu:Remove()
	end

	impulse.WORKFORCERankMenu = self
...
local textIO = {
	[TEAM_WORKFORCE] = {
		["header:title"] = "WORKFORCE Enlistment",
...
vgui.Register("impulseWorkforceRankMenu", PANEL, "DPanel")
