...
function impulse.Voice.ChatClassMessageGet(class, message, sender, targets)
	local sounds, message = impulse.Voice.GetVoiceList(class, message)
...
impulse.Voice.ChatTypes[9] = true -- cmd radio
impulse.Voice.ChatTypes[10] = true -- sqd radio
--impulse.Voice.ChatTypes[16] = true -- dispatch

-- impulse.Voice.DefineClass("dispatch", function(ply)
	-- return table.HasValue( dispWL, ply:SteamID64() ) or (ply:Team() == TEAM_CP and table.HasValue( dispWL, ply:SteamID64() ) )
-- end, function(client, sounds, chatType)
	-- local beeps = impulse.Config.BeepSounds[TEAM_CP]

	-- table.insert(sounds, 1, {(table.Random(beeps.on)), 0.15})
	-- sounds[#sounds + 1] = {(table.Random(beeps.off)), nil, 0.15}
-- end)
...
sound.Add({name="MaleCitizen.CPs",sound={"vo/npc/male01/cps01.wav","vo/npc/male01/cps02.wav"},channel=CHAN_AUTO})
sound.Add({name="MaleCitizen.Hi",sound={"vo/npc/male01/hi01.wav","vo/npc/male01/hi02.wav"},channel=CHAN_AUTO})
sound.Add({name="MaleCitizen.Scanners",sound={
	"vo/npc/male01/scanners01.wav",
	"vo/npc/male01/scanners02.wav"
},channel=CHAN_AUTO})
sound.Add({name="MaleCitizen.RunForLife",sound={
	"vo/npc/male01/runforyourlife01.wav",
	"vo/npc/male01/runforyourlife02.wav",
	"vo/npc/male01/runforyourlife03.wav"
},channel=CHAN_AUTO})
sound.Add({name="MaleCitizen.Hacks",sound={
	"vo/npc/male01/hacks01.wav",
	"vo/npc/male01/hacks02.wav"
},channel=CHAN_AUTO})
impulse.Voice.DefineClass("citizen_male", function(ply)
	if not ply:IsDonator() then return false end
	if not ply:IsCharacterFemale() then
		return ply:Team() == TEAM_CITIZEN or ply:Team() == TEAM_CWU
	end
end)
sound.Add({name="FeMaleCitizen.CPs",sound={"vo/npc/female01/cps01.wav","vo/npc/female01/cps02.wav"},channel=CHAN_AUTO})
sound.Add({name="FeMaleCitizen.Hi",sound={"vo/npc/female01/hi01.wav","vo/npc/female01/hi02.wav"},channel=CHAN_AUTO})
sound.Add({name="FeMaleCitizen.No",sound={"vo/npc/female01/no01.wav","vo/npc/female01/no02.wav"},channel=CHAN_AUTO})
sound.Add({name="FeMaleCitizen.Scanners",sound={
	"vo/npc/female01/scanners01.wav",
	"vo/npc/female01/scanners02.wav"
},channel=CHAN_AUTO})
sound.Add({name="FeMaleCitizen.RunForLife",sound={
	"vo/npc/female01/runforyourlife01.wav",
	"vo/npc/female01/runforyourlife02.wav"
},channel=CHAN_AUTO})
sound.Add({name="FeMaleCitizen.Hacks",sound={
	"vo/npc/female01/hacks01.wav",
	"vo/npc/female01/hacks02.wav"
},channel=CHAN_AUTO})
impulse.Voice.DefineClass("citizen_female", function(ply)
	if not ply:IsDonator() then return false end
...
impulse.Voice.Register("combine", "..getout", "Get out of here!", "npc/metropolice/vo/getoutofhere.wav")
...
impulse.Voice.Register("citizen_male", ".ROT IN HELL", "Rot in hell!", "vo/episode_1/npc/male01/cit_kill17.wav")
impulse.Voice.Register("citizen_male", ".COMBINE", "Combine!", "vo/npc/male01/combine01.wav")
impulse.Voice.Register("citizen_male", ".CPS", "CPs!", "MaleCitizen.CPs")
impulse.Voice.Register("citizen_male", ".NO... NO", "No... no...", "vo/npc/male01/no01.wav")
impulse.Voice.Register("citizen_male", ".NO", "No!", "vo/npc/male01/no02.wav")
impulse.Voice.Register("citizen_male", ".HI", "Hi", "MaleCitizen.Hi")
impulse.Voice.Register("citizen_male", ".HELP", "Help!", "vo/npc/male01/help01.wav")
impulse.Voice.Register("citizen_male", ".GET OUT", "Get the hell out of here!", "vo/npc/male01/gethellout.wav")
impulse.Voice.Register("citizen_male", ".BULLSHIT", "This is bullshit!", "vo/npc/male01/question26.wav")
impulse.Voice.Register("citizen_male", ".YEAH", "Yeah.", "vo/npc/male01/yeah02.wav")
impulse.Voice.Register("citizen_male", ".MUMBO JUMBO", "Enough of your mumbo jumbo.", "vo/npc/male01/vanswer01.wav")
impulse.Voice.Register("citizen_male", ".WHOOPS", "Whoops.", "vo/npc/male01/whoops01.wav")
impulse.Voice.Register("citizen_male", ".HEY ITS ME", "Hey, it's me. Open the door!", "vo/streetwar/tunnel/male01/c17_06_password01.wav")
impulse.Voice.Register("citizen_male", ".WHAT PASSWORD", "What's the password?", "vo/streetwar/tunnel/male01/c17_06_password02.wav")
impulse.Voice.Register("citizen_male", ".PASSWORD", "Password!", "vo/streetwar/tunnel/male01/c17_06_password03.wav")
impulse.Voice.Register("citizen_male", ".COME ON IN", "Come on in.", "vo/streetwar/tunnel/male01/c17_06_password04.wav")
impulse.Voice.Register("citizen_male", ".TALKIN ME", "You talkin' to me?", "vo/npc/male01/answer30.wav")
impulse.Voice.Register("citizen_male", ".NIP THAT TALK IN THE BUD", "You should nip that kind of talk in the bud", "vo/npc/male01/answer31.wav")
impulse.Voice.Register("citizen_male", ".SHOWER", "I can't remember the last time I had a shower.", "vo/npc/male01/question19.wav")
impulse.Voice.Register("citizen_male", ".CANT GET TUNE", "I can't get this tune out of my head. *Whistles*", "vo/npc/male01/question23.wav")
impulse.Voice.Register("citizen_male", ".HORSE HOOVES", "Ugh, I could eat a horse, hooves and all.", "vo/npc/male01/question09.wav")
impulse.Voice.Register("citizen_male", ".CHEESE", "Sometimes... I dream... about cheese...", "vo/npc/male01/question06.wav")
impulse.Voice.Register("citizen_male", ".SCANNERS", "Scanners!", "MaleCitizen.Scanners")
impulse.Voice.Register("citizen_male", ".RUN FOR YOUR LIFE", "Run for your life!", "MaleCitizen.RunForLife")
impulse.Voice.Register("citizen_female", ".ROT IN HELL", "Rot in hell!", "vo/episode_1/npc/female01/cit_kill17.wav")
impulse.Voice.Register("citizen_female", ".COMBINE", "Combine!", "vo/npc/female01/combine01.wav")
impulse.Voice.Register("citizen_female", ".CPS", "CPs!", "FeMaleCitizen.CPs")
--impulse.Voice.Register("citizen_female", "NO... NO", "vo/npc/female01/no01.wav")
impulse.Voice.Register("citizen_female", ".NO", "No!", "FeMaleCitizen.No")
--impulse.Voice.Register("citizen_female", "NO", "No!", "vo/npc/female01/no02.wav")
impulse.Voice.Register("citizen_female", ".HI", "Hi", "FeMaleCitizen.Hi")
impulse.Voice.Register("citizen_female", ".HELP", "Help!", "vo/npc/female01/help01.wav")
impulse.Voice.Register("citizen_female", ".GET OUT", "Get the hell out of here!", "vo/npc/female01/gethellout.wav")
impulse.Voice.Register("citizen_female", ".BULLSHIT", "This is bullshit!", "vo/npc/female01/question26.wav")
impulse.Voice.Register("citizen_female", ".YEAH", "Yeah.", "vo/npc/female01/yeah02.wav")
impulse.Voice.Register("citizen_female", ".MUMBO JUMBO", "Enough of your mumbo jumbo.", "vo/npc/female01/vanswer01.wav")
impulse.Voice.Register("citizen_female", ".WHOOPS", "Whoops.", "vo/npc/female01/whoops01.wav")
impulse.Voice.Register("citizen_female", ".HEY ITS ME", "Hey, it's me. Open the door!", "vo/streetwar/tunnel/female01/c17_06_password01.wav")
impulse.Voice.Register("citizen_female", ".WHAT PASSWORD", "What's the password?", "vo/streetwar/tunnel/female01/c17_06_password02.wav")
impulse.Voice.Register("citizen_female", ".COME ON IN", "Come on in.", "vo/streetwar/tunnel/female01/c17_06_password04.wav")
impulse.Voice.Register("citizen_female", ".TALKIN ME", "You talkin' to me?", "vo/npc/female01/answer30.wav")
impulse.Voice.Register("citizen_female", ".NIP THAT TALK IN THE BUD", "You should nip that kind of talk in the bud", "vo/npc/female01/answer31.wav")
impulse.Voice.Register("citizen_female", ".SHOWER", "I can't remember the last time I had a shower.", "vo/npc/female01/question19.wav")
impulse.Voice.Register("citizen_female", ".CANT GET TUNE", "I can't get this tune out of my head. *Whistles*", "vo/npc/female01/question23.wav")
impulse.Voice.Register("citizen_female", ".HORSE HOOVES", "Ugh, I could eat a horse, hooves and all.", "vo/npc/female01/question09.wav")
impulse.Voice.Register("citizen_female", ".CHEESE", "Sometimes... I dream... about cheese...", "vo/npc/female01/question06.wav")
impulse.Voice.Register("citizen_female", ".SCANNERS", "Scanners!", "FeMaleCitizen.Scanners")
impulse.Voice.Register("citizen_female", ".RUN FOR YOUR LIFE", "Run for your life!", "FeMaleCitizen.RunForLife")
if CLIENT then
	concommand.Add("impulse_hl2rp_printvcs", function(ply, cmd, args)
		if not args[1] then
			return print("Enter class as argument 1. (E.G. 'combine', 'vort', 'citizen_male', or 'citizen_female')")
		end
