...
function InitializeHuds()
	...
	hook.Add("HUDPaint", "LegacyHatchetCrosshair", function()
		...
		if ( IsValid(impulse.MainMenu) and impulse.MainMenu:IsVisible() ) or IsValid(impulse.SplashScreen) or impulse.hudEnabled == false or (impulse.CinematicIntro and LocalPlayer():Alive()) or (IsValid(impulse.MainMenu) and impulse.MainMenu:IsVisible()) or hook.Run("ShouldDrawHUDBox") == false or impulse.GetSetting("crosshair_selection") != "Hatchet Legacy" then
			return
		end
	...
	hook.Add("HUDPaint", "HalfLifeTwoCrosshair", function()
		...
		if ( IsValid(impulse.MainMenu) and impulse.MainMenu:IsVisible() ) or IsValid(impulse.SplashScreen) or impulse.hudEnabled == false or (impulse.CinematicIntro and LocalPlayer():Alive()) or (IsValid(impulse.MainMenu) and impulse.MainMenu:IsVisible()) or hook.Run("ShouldDrawHUDBox") == false or impulse.GetSetting("crosshair_selection") != "Half-Life 2" then
			return
		end
	...
	hook.Add("HUDPaint", "CircleDotCrosshair", function()
		...
		if ( IsValid(impulse.MainMenu) and impulse.MainMenu:IsVisible() ) or IsValid(impulse.SplashScreen) or impulse.hudEnabled == false or (impulse.CinematicIntro and LocalPlayer():Alive()) or (IsValid(impulse.MainMenu) and impulse.MainMenu:IsVisible()) or hook.Run("ShouldDrawHUDBox") == false or impulse.GetSetting("crosshair_selection") != "Circle + Dot" then
			return
		end
