...
SWEP.WorldModel = Model("models/weapons/w_pist_glock01.mdl")
SWEP.ViewModel = Model("models/weapons/c_smg1.mdl")
SWEP.ViewModelFOV = 55
SWEP.ViewModelOffset = Vector(0, 0, 0)

SWEP.Primary.Shell = "CS_MuzzleFlash"
SWEP.Primary.ShellScale = .35
SWEP.Primary.ShellAttachment = 1
...
SWEP.ReloadSound = Sound("weapons/fiveseven/fiveseven_clipin.wav")
SWEP.EmptySound = Sound("Weapon_SMG1.Empty")

SWEP.Primary.Sound = Sound("weapons/cw_fiveseven/fire.wav")

SWEP.Primary.Recoil = .6
SWEP.Primary.Damage = 13
SWEP.Primary.NumShots = 1
SWEP.Primary.Cone = 0.03
SWEP.Primary.Delay = Plutonic.FireRate.RPM(420)
