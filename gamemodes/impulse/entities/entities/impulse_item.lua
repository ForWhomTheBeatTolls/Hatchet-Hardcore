...
if SERVER then
	function ENT:Initialize()
		...
		self.UseDelay = CurTime() + 0.75
	end
    
	function ENT:OnTakeDamage(damageInfo) -- This function, including the ENT:OnRemove() function is ripped from Helix. It serves our purpose well.
