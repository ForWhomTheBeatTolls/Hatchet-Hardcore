...
function PANEL:SetPlayer(player)
	...
	self.profileImage:SetSize(50, 50)
	self.profileImage:SetPos(10, 5)
	...
	surface.SetDrawColor(darkCol)
	 ...
	 if LocalPlayer():IsAdmin() then 
		...
		if impulse.GetSetting("admin_showgroup") and rpGroup then
			icName = icName.." ("..rpGroup..")".." (".. self.Player:Team() ..")"
		end
	 end
	 surface.DrawText(self.Player:SteamName()..icName)

	 -- Ping
	 surface.SetTextPos(w / 2,30)
	 surface.DrawText(self.Player:Ping().."ms Ping")
