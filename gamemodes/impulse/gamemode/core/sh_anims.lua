...
impulse.Anim.citizen_male = {
	normal = {
		...
		[ACT_MP_WALK] = {ACT_HL2MP_WALK, ACT_HL2MP_WALK},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_WALK_CROUCH},
		[ACT_MP_RUN] = {ACT_HL2MP_RUN_FAST, ACT_HL2MP_RUN_FAST},
		eat = G_FIST_R
	},
	suitcase = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE_SUITCASE, ACT_IDLE_SUITCASE},
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_LOW, ACT_COVER_LOW},
		[ACT_MP_WALK] = {ACT_WALK_SUITCASE, ACT_WALK_SUITCASE},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_WALK_CROUCH},
	...
	-- else
		...
		-- if IsValid(weapon) then
			...
			-- elseif event == PLAYERANIMEVENT_CUSTOM_GESTURE_SEQUENCE then
				-- ply:AddVCDSequenceToGestureSlot(GESTURE_SLOT_CUSTOM, ply:LookupSequence(table.Random(randomtalking)), true)
				-- print(ply:LookupSequence(table.Random(randomtalking)))
				-- return ACT_INVALID
